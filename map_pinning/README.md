...
* Pin the map using map id (note: "test_map" name differs from the kernel program's map declaration. This can be convenient since <map_name> can be anything you want)
